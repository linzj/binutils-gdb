...
export LDFLAGS="-pie -static-libstdc++ --sysroot=$NDK_PATH/toolchains/llvm/prebuilt/$HOST/sysroot -L$NDK_PATH/sources/cxx-stl/llvm-libc++/libs/$ARCH -L$NDK_PATH/toolchains/llvm/prebuilt/$HOST/sysroot/usr/lib/$TARGET/21/ -B/Users/zuojianlin/Library/Android/sdk/ndk-bundle/toolchains/$TARGET-4.9/prebuilt/$HOST/$TARGET/bin"
